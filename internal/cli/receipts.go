...
func init() {
	receiptsCmd.PersistentFlags().StringVar(&flagReceiptsDir, "dir", "", "receipts directory (default: ~/Downloads/経理/領収書 or $GRCLONE_RECEIPTS_DIR)")
